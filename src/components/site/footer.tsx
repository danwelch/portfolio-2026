...
export function SiteFooter() {
  return (
    <footer className="border-t border-border/60 pt-10 pb-0 text-sm text-muted-foreground flex flex-col gap-2">
      ...
      <p className="mt-1 leading-relaxed flex flex-col @xl:flex-row @xl:flex-wrap gap-y-1">
        <span>Built with{" "}
        ...
        <span className="@xl:before:content-['·'] @xl:before:mx-2">Typeset in{" "}
        ...
        <span className="@xl:before:content-['·'] @xl:before:mx-2">Deployed on{" "}
